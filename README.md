# printf()
The printf project is a collaboration project by <a href="https://github.com/noahchernet">@noahchernet</a> and <a href="https://github.com/mikialx">@mikialx</a>, students of the ALX Software Engineering Programme by Holberton School, in which a function named "_printf" imitates the actual "printf" command located in the stdio.h library. It contains some of the basic features and functions found in the manual 3 of "printf".
